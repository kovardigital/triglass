...
import * as Earth from './liftoff/earth.js';
...
Bubbles.init(worldGroup, camera, renderer);
Preloader.setProgress(0.9);

Earth.init(worldGroup, camera, null);
Preloader.setProgress(0.95);
...
Loop.onUpdate('earth', Earth.update);
